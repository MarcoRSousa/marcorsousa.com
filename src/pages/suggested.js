...
export default function Suggest() {
  ...
  <Layout>
    ...
    <p> I enjoy a great deal of content creators and books, and I would like to support some of them here. </p>
    <br/>
    <div className={suggestedStyle.suggested}>
      ...
      <ol>
        ...
        <li> <a href= "https://www.youtube.com/c/SimonOxfPhys" target = "_blank" rel="noopener noreferrer">Simon Clark</a></li>
        <li> <a href= "https://www.youtube.com/c/papaflammy" target = "_blank" rel="noopener noreferrer">Flammable Maths</a></li>
      </ol>
      <h4> Music </h4>
    ...
    <h3>Mathematics And Data</h3>
      <ol className={suggestedStyle.suggested}>
        ...
        <li>George Best: Calculus, Concepts and Calculators</li>
        <li> <a href= "https://www.amazon.com/Calculus-Early-Transcendentals-James-Stewart/dp/1285741552" target = "_blank" rel="noopener noreferrer">James Stewart: Calculus Early Transcendentals</a></li>
        <li>Dimitri P. Bersekas: Introduction To Probability</li>
        <li>Gary Chartrand: Discrete Mathematics</li>
        <li>John Beachy & William Blair: Abstract Algebra</li>
        <li>David Lay: Linear Algebra And It's Applications</li>
        <li>Randall J. LeVeque: Finite Difference Methods for Ordinary and Partial Differential Equations</li>
        <li>Lars Eldén: Matrix Methods in Data Mining and Pattern Recognition</li>
        <li>Richard E. Neapolitan: Foundations Of Algorithms</li>
        <li>Gareth James: An Introduction to Statistical Learning</li>
        <li> <a href= "https://www.amazon.com/Fundamentals-Analysis-Applications-Engineering-Mathematics/dp/0139078746" target = "_blank" rel="noopener noreferrer"> Edward B. Saff: Fundamentals of Complex Analysis with Applications</a></li>
        <li>Tamara Munzner: Visualization Analysis & Design</li>
      </ol>

      
      <h4> Mathematics (Optional Readings) </h4>
      <ol>
      <li>Adrian Baddeley: Analysing Spatial Point Patterns in R</li>
      <li>Martin Weissman: An Illustrated Theory of Numbers</li>
      </ol>
